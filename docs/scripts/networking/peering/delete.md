...
## Purpose
Run `delete` for `peering` networking objects using validated flags.

## Location
`networking/peering/delete.sh`
...
## Usage
```bash
networking/peering/delete.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
