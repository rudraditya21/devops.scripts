...
## Purpose
Run `delete` for `egress` networking objects using validated flags.

## Location
`networking/egress/delete.sh`
...
## Usage
```bash
networking/egress/delete.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
