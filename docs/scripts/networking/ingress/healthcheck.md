...
## Purpose
Run baseline health checks for `ingress` networking workflows.

## Location
`networking/ingress/healthcheck.sh`
...
## Usage
```bash
networking/ingress/healthcheck.sh --endpoint edge.example.internal --strict
```
