...
## Purpose
Generate quick-reference documentation for the shared validation module.

## Location
`shared/validation/doc.sh`
...
```bash
shared/validation/doc.sh
shared/validation/doc.sh --format text --output /tmp/validation-doc.txt
```
