...
## Purpose
Run baseline health checks for `dns` networking workflows.

## Location
`networking/dns/healthcheck.sh`
...
## Usage
```bash
networking/dns/healthcheck.sh --endpoint edge.example.internal --strict
```
