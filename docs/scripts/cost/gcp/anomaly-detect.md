...
## Purpose
Detect abnormal `gcp` spend deviations relative to baseline.

## Location
`cost/gcp/anomaly-detect.sh`
...
## Usage
```bash
cost/gcp/anomaly-detect.sh --baseline 900 --current 1310 --threshold-percent 25
```
