...
## Purpose
Export `database` cost optimization recommendations in CSV or JSON.

## Location
`cost/database/recommendations-export.sh`
...
## Usage
```bash
cost/database/recommendations-export.sh --format json --top 10
```
