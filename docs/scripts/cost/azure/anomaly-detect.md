...
## Purpose
Detect abnormal `azure` spend deviations relative to baseline.

## Location
`cost/azure/anomaly-detect.sh`
...
## Usage
```bash
cost/azure/anomaly-detect.sh --baseline 900 --current 1310 --threshold-percent 25
```
