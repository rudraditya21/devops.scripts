...
## Purpose
Generate `storage` cost report snapshots for a selected time window.

## Location
`cost/storage/report.sh`
...
## Usage
```bash
cost/storage/report.sh --estimated-total 1243.77 --scope production
```
