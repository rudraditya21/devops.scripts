...
## Purpose
Run TCP healthcheck for `prometheus` monitoring workflows.

## Location
`monitoring/prometheus/healthcheck.sh`
...
## Usage
```bash
monitoring/prometheus/healthcheck.sh --target 127.0.0.1 --strict
```
