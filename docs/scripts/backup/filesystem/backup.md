...
## Purpose
Create backup artifacts for the `filesystem` backup domain.

## Location
`backup/filesystem/backup.sh`
...
## Usage
```bash
backup/filesystem/backup.sh --source /data/app --output /backups/filesystem/app-2026-04-01.tar.gz
```
