...
## Purpose
Export `storage` cost optimization recommendations in CSV or JSON.

## Location
`cost/storage/recommendations-export.sh`
...
## Usage
```bash
cost/storage/recommendations-export.sh --format json --top 10
```
