...
## Purpose
Export `kubernetes` cost optimization recommendations in CSV or JSON.

## Location
`cost/kubernetes/recommendations-export.sh`
...
## Usage
```bash
cost/kubernetes/recommendations-export.sh --format json --top 10
```
