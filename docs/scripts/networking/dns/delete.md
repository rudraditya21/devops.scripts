...
## Purpose
Run `delete` for `dns` networking objects using validated flags.

## Location
`networking/dns/delete.sh`
...
## Usage
```bash
networking/dns/delete.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
