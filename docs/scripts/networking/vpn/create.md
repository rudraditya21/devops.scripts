...
## Purpose
Run `create` for `vpn` networking objects using validated flags.

## Location
`networking/vpn/create.sh`
...
## Usage
```bash
networking/vpn/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
