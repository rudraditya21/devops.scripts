...
## Purpose
Check `storage` spend against budget and warning thresholds.

## Location
`cost/storage/budget-check.sh`
...
## Usage
```bash
cost/storage/budget-check.sh --budget-limit 2000 --current-spend 1710 --warn-percent 85
```
