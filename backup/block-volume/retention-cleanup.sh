...
Delete expired block-volume backup artifacts based on retention policy.

Options:
  --backup-dir DIR     Backup directory to prune (default: ./backups/block-volume)
...
backup_dir="./backups/block-volume"
days="30"
pattern="*"
dry_run=false
