...
## Purpose
Check `database` spend against budget and warning thresholds.

## Location
`cost/database/budget-check.sh`
...
## Usage
```bash
cost/database/budget-check.sh --budget-limit 2000 --current-spend 1710 --warn-percent 85
```
