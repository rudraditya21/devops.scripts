...
## Purpose
Create backup artifacts for the `kubernetes` backup domain.

## Location
`backup/kubernetes/backup.sh`
...
## Usage
```bash
backup/kubernetes/backup.sh --source /data/app --output /backups/kubernetes/app-2026-04-01.tar.gz
```
