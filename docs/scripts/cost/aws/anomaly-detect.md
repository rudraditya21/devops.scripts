...
## Purpose
Detect abnormal `aws` spend deviations relative to baseline.

## Location
`cost/aws/anomaly-detect.sh`
...
## Usage
```bash
cost/aws/anomaly-detect.sh --baseline 900 --current 1310 --threshold-percent 25
```
