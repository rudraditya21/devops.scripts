...
## Purpose
Run `delete` for `nat` networking objects using validated flags.

## Location
`networking/nat/delete.sh`
...
## Usage
```bash
networking/nat/delete.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
