...
## Purpose
Run `create` for `firewall` networking objects using validated flags.

## Location
`networking/firewall/create.sh`
...
## Usage
```bash
networking/firewall/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
