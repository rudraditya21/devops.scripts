...
## Purpose
Generate `database` cost report snapshots for a selected time window.

## Location
`cost/database/report.sh`
...
## Usage
```bash
cost/database/report.sh --estimated-total 1243.77 --scope production
```
