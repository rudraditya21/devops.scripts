...
## Purpose
Detect abnormal `database` spend deviations relative to baseline.

## Location
`cost/database/anomaly-detect.sh`
...
## Usage
```bash
cost/database/anomaly-detect.sh --baseline 900 --current 1310 --threshold-percent 25
```
