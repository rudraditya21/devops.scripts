...
## Purpose
Run `create` for `ingress` networking objects using validated flags.

## Location
`networking/ingress/create.sh`
...
## Usage
```bash
networking/ingress/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
