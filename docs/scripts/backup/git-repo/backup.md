...
## Purpose
Create backup artifacts for the `git-repo` backup domain.

## Location
`backup/git-repo/backup.sh`
...
## Usage
```bash
backup/git-repo/backup.sh --source /data/app --output /backups/git-repo/app-2026-04-01.tar.gz
```
