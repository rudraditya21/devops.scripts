...
## Purpose
Run baseline health checks for `peering` networking workflows.

## Location
`networking/peering/healthcheck.sh`
...
## Usage
```bash
networking/peering/healthcheck.sh --endpoint edge.example.internal --strict
```
