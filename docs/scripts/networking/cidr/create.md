...
## Purpose
Run `create` for `cidr` networking objects using validated flags.

## Location
`networking/cidr/create.sh`
...
## Usage
```bash
networking/cidr/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
