...
## Purpose
Run `create` for `dns` networking objects using validated flags.

## Location
`networking/dns/create.sh`
...
## Usage
```bash
networking/dns/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
