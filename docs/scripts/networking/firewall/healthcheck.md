...
## Purpose
Run baseline health checks for `firewall` networking workflows.

## Location
`networking/firewall/healthcheck.sh`
...
## Usage
```bash
networking/firewall/healthcheck.sh --endpoint edge.example.internal --strict
```
