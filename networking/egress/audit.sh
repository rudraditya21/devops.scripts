...
Audit egress networking objects and summarize risk/state.
...
if $json; then
  printf '[{"domain":"egress","scope":"%s","object":"edge-a","status":"ok"},{"domain":"egress","scope":"%s","object":"edge-b","status":"review"}]\n' \
