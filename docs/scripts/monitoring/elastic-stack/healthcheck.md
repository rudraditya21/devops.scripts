...
## Purpose
Run TCP healthcheck for `elastic-stack` monitoring workflows.

## Location
`monitoring/elastic-stack/healthcheck.sh`
...
## Usage
```bash
monitoring/elastic-stack/healthcheck.sh --target 127.0.0.1 --strict
```
