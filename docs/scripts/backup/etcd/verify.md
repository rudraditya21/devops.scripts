...
## Purpose
Verify presence and integrity of `etcd` backup artifacts.
...
## Usage
```bash
backup/etcd/verify.sh --backup /backups/etcd/app.tar.gz
backup/etcd/verify.sh --backup /backups/etcd/app.tar.gz --json
```
