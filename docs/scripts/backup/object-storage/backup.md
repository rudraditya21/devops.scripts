...
## Purpose
Create backup artifacts for the `object-storage` backup domain.

## Location
`backup/object-storage/backup.sh`
...
## Usage
```bash
backup/object-storage/backup.sh --source /data/app --output /backups/object-storage/app-2026-04-01.tar.gz
```
