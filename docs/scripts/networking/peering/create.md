...
## Purpose
Run `create` for `peering` networking objects using validated flags.

## Location
`networking/peering/create.sh`
...
## Usage
```bash
networking/peering/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
