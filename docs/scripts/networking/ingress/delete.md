...
## Purpose
Run `delete` for `ingress` networking objects using validated flags.

## Location
`networking/ingress/delete.sh`
...
## Usage
```bash
networking/ingress/delete.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
