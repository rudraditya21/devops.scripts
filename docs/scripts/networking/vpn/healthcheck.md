...
## Purpose
Run baseline health checks for `vpn` networking workflows.

## Location
`networking/vpn/healthcheck.sh`
...
## Usage
```bash
networking/vpn/healthcheck.sh --endpoint edge.example.internal --strict
```
