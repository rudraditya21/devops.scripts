...
Audit cidr networking objects and summarize risk/state.
...
if $json; then
  printf '[{"domain":"cidr","scope":"%s","object":"edge-a","status":"ok"},{"domain":"cidr","scope":"%s","object":"edge-b","status":"review"}]\n' \
