...
## Purpose
Run baseline health checks for `egress` networking workflows.

## Location
`networking/egress/healthcheck.sh`
...
## Usage
```bash
networking/egress/healthcheck.sh --endpoint edge.example.internal --strict
```
