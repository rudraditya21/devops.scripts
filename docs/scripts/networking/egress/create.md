...
## Purpose
Run `create` for `egress` networking objects using validated flags.

## Location
`networking/egress/create.sh`
...
## Usage
```bash
networking/egress/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
