...
## Purpose
Run `create` for `nat` networking objects using validated flags.

## Location
`networking/nat/create.sh`
...
## Usage
```bash
networking/nat/create.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
