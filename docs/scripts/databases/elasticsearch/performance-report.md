...
## Purpose
Run `performance-report.sh` for `elasticsearch` database operations.

## Location
`databases/elasticsearch/performance-report.sh`
...
## Usage
```bash
databases/elasticsearch/performance-report.sh --help
```
