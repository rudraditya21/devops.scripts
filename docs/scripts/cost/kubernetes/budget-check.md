...
## Purpose
Check `kubernetes` spend against budget and warning thresholds.

## Location
`cost/kubernetes/budget-check.sh`
...
## Usage
```bash
cost/kubernetes/budget-check.sh --budget-limit 2000 --current-spend 1710 --warn-percent 85
```
