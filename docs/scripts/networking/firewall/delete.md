...
## Purpose
Run `delete` for `firewall` networking objects using validated flags.

## Location
`networking/firewall/delete.sh`
...
## Usage
```bash
networking/firewall/delete.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
