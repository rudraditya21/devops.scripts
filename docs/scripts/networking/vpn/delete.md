...
## Purpose
Run `delete` for `vpn` networking objects using validated flags.

## Location
`networking/vpn/delete.sh`
...
## Usage
```bash
networking/vpn/delete.sh --name app-edge --target prod --cidr 10.10.0.0/24 --dry-run
```
