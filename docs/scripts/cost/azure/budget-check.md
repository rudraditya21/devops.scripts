...
## Purpose
Check `azure` spend against budget and warning thresholds.

## Location
`cost/azure/budget-check.sh`
...
## Usage
```bash
cost/azure/budget-check.sh --budget-limit 2000 --current-spend 1710 --warn-percent 85
```
