...
## Purpose
Run baseline health checks for `gateway` networking workflows.

## Location
`networking/gateway/healthcheck.sh`
...
## Usage
```bash
networking/gateway/healthcheck.sh --endpoint edge.example.internal --strict
```
